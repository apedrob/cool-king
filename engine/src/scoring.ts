import { Player, GameState, GamePhase } from "./types.js";
 ...
 */
export function calculateScore(player: Player, round: number, bonus: number = 0): number {
    if (player.bid === undefined) return 0;
