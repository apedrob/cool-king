<script lang="ts">
    ...
    onMount(() => {
        ...
        document.title =
            "Last Round vs Skull King | #1 Free Online Alternative";

        // Ensure meta description is set for this route specifically if needed
...
<div class="vs-screen wood-bg">
    ...
    <div class="content-container parchment">
        ...
        <div class="cta-section">
            <a href="/" class="btn-leather prominent">
                <span class="btn-icon">{@html skullIcon}</span> HOST A GAME NOW
            </a>
        </div>
    </div>
</div>
...
<style>
    ...
    .content-container {
        ...
        padding: 48px;
        border-radius: 12px;
        border: 1px solid rgba(139, 96, 32, 0.4);
